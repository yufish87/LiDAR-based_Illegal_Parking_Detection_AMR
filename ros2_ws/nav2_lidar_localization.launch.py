...
def generate_launch_description():
    ...
    cloud_topic = LaunchConfiguration('cloud_topic', default='/ouster/points')
    ...
    lidar_frame_id = LaunchConfiguration('lidar_frame_id', default='os_lidar')
    ...
    ld.add_action(DeclareLaunchArgument('cloud_topic', default_value='/ouster/points'))
    ld.add_action(DeclareLaunchArgument('twist_topic', default_value='/twist'))
    ld.add_action(DeclareLaunchArgument('imu_topic', default_value='/ouster/imu'))
    ld.add_action(DeclareLaunchArgument('publish_lidar_tf', default_value='false'))
    ld.add_action(DeclareLaunchArgument('lidar_frame_id', default_value='os_lidar'))
    ...
    lidar_localization = LifecycleNode(
        ...
        parameters=[localization_param_dir,
                    ...
                    }, {'map_path': '/home/saitama/ros2_ws/final_map_V1_9_8_F_FLATTENED.pcd'}
