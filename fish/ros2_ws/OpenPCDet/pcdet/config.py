...
def merge_new_config(config, new_config):
    if '_BASE_CONFIG_' in new_config:
        base_cfg_path = Path(new_config['_BASE_CONFIG_'])
        if not base_cfg_path.exists():
            base_cfg_path = Path(cfg.ROOT_DIR) / new_config['_BASE_CONFIG_']
            if not base_cfg_path.exists():
                base_cfg_path = Path(cfg.ROOT_DIR) / 'tools' / new_config['_BASE_CONFIG_']
